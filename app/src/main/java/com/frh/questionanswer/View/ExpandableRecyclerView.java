...
public class ExpandableRecyclerView extends RecyclerView {
    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder {
        ...
        public SimpleGroupViewHolder(Context context) {
            ...
            textViewGroupText = itemView.findViewById(R.id.textView_group_title);
            imageViewUser = itemView.findViewById(R.id.imageView_expand);
            imageViewUser.setBackgroundResource(R.drawable.ic_add);
        }
...
//                    imageviewGroupExpanded.postInvalidate();
                    imageViewUser.setBackgroundResource(R.drawable.ic_remove);
                }
            });
            animator.start();
            expanded = true;
